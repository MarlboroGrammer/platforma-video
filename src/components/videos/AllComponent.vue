    ...
    <div class="container">
        ...
        <div v-if="!loading">
            ...
            <div id="products" class="row list-group">
                ...
                >
                  <div class="item  ol-xs-4 col-lg-4 grid-group-item" v-for="(video) in paginated('videos')" :key="video.id">
                      <div class="thumbnail">
                          <div v-if="video.thumbnail">
                              <img class="group list-group-image" :src="'https://48gekijodouga.net/i/'+video.thumbnail" alt="Thumbnail" width="330" v-if="env === 'production'" />
                              <img class="group list-group-image" :src="'http://localhost:3000/i/'+video.thumbnail" alt="Thumbnail" width="330" v-if="env !== 'production'"/>
                          </div>
                          <div class="caption">
            ...
            <center><paginate-links for="videos" :show-step-links="true"></paginate-links></center>
        </div>
    </div>
</template>
